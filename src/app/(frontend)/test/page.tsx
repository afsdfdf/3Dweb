...
const pageMappings: PageMapSpec[] = [
  ...
  {
    path: '/login',
    note: 'Auth entry page',
    components: ['AuthFlowCard'],
    dataSources: ['client auth form state'],
    endpoints: ['/api/account/auth/login', '/api/account/auth/register', '/api/account/auth/forgot-password', '/api/account/auth/me'],
  },
  {
    path: '/register',
    note: 'Auth register page',
    components: ['AuthFlowCard'],
    dataSources: ['client auth form state'],
